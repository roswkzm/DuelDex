...
import com.example.dueldex.core.model.enums.CardType
import com.example.dueldex.core.model.enums.EffectType
import com.example.dueldex.core.model.enums.RaceType
...
fun SearchFilterBottomSheetContent(
    ...
    Column(
        ...
        Text(
            ...
            style = MaterialTheme.ddTypography.fontTitleL.copy(fontWeight = FontWeight.Bold),
